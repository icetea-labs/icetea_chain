...
(function (root, factory) {
  ...
  var BotUI = function (id, opts) {
    ...
    var _interface = {}
    // methods returned by a BotUI() instance.
    ...
    var _fontAwesome = 'https://use.fontawesome.com/ea731dcb6f.js'

    var _esPromisePollyfill = 'https://cdn.jsdelivr.net/es6-promise/4.1.0/es6-promise.min.js'
    // mostly for IE

    var _searchselect = 'https://unpkg.com/vue-select@2.4.0/dist/vue-select.js'
    ...
    function _addMessage (_msg) {
      ...
      _msg.visible = !((_msg.delay || _msg.loading))
